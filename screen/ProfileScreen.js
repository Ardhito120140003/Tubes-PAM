...
const ProfileScreen = () => {
  return (
    <View style={styles.uSERPROFILEPAGE}>
      ...
      <Text style={styles.dilanCepmekText}>Dilan Cepmek</Text>
      ...
      <TouchableOpacity style={styles.pesananDikomplainText}>Pesanan dikomplain</TouchableOpacity>
      <TouchableOpacity style={styles.bantuanSuSCare}>Bantuan SuS Care</TouchableOpacity>
      ...
      />
      <TouchableOpacity style={styles.btnBuyView}>
